...
export default function App() {
    ...
    return (
        <BrowserRouter><Routes><Route path="/testes" element={<Teste/>}></Route></Routes></BrowserRouter>
    // <div
    //     style={{backgroundColor: '#0f1117', height: '100vh', display: 'flex', flexDirection: 'column', color: 'white'}}>
